...
lines.append("\\caption{OR-Tools GLS Performance with Log-normal Statistics (2s timeout, 10,000 instances)}")
lines.append("\\label{tab:ortools-gls-2s}")
...
lines.append("\\item Time limit: 2s per instance")
lines.append("\\end{tablenotes}")
lines.append("\\end{table*}")

# Save table with proper newlines
with open('ortools_gls_2s_table.tex', 'w') as f:
    f.write('\n'.join(lines))

print("Generated ortools_gls_2s_table.tex")

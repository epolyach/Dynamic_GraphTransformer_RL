#!/usr/bin/env python3
"""
GPU Exact Benchmark for N=20 with truly optimal solutions.
...
def benchmark_gpu_exact_n10(num_instances=10000, batch_size=10, capacity=20):
    """
    Benchmark truly exact GPU solver for N=20.
    ...
    # Memory estimate
    states = 2 ** n_customers  # 1048576 for N=20
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='GPU Truly Exact CVRP Benchmark for N=20')

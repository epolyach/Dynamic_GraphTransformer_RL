...
from src.benchmarking.solvers.gpu.heuristic_gpu_gls import GPUHeuristicGLS, solve_batch
...
def run_benchmark_configuration(n_customers: int, capacity: int, num_instances: int,
    ...
    for batch_idx in range(num_batches):
        ...
        solutions = solve_batch(instances, time_limit=time_limit, verbose=verbose)
...
def main():
    ...
    print("\n" + "="*80)
    print("GPU Advanced GLS CVRP Benchmark (PyTorch CUDA)")
    ...
    print("\n" + "="*80)
    print("FINAL RESULTS - GPU Advanced GLS (PyTorch CUDA)")
    print("="*80)

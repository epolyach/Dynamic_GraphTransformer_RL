...
def run_test(n_instances):
    ...
    for i, instance in enumerate(instances):
        if i % 100 == 0 and i > 0:
            print(f"Progress: {i}/{n_instances}")
        result = ortools_exact_solve(instance, time_limit=30.0, verbose=False)
...
print("Running OR-Tools EXACT solver...")

# Run for 100 instances
print("\nTesting 100 instances...")

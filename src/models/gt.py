...
class GraphTransformer(nn.Module):
    ...
    def __init__(self, input_dim: int, hidden_dim: int, num_heads: int, 
        ...
        self.hidden_dim = hidden_dim
        self.num_heads = num_heads
        self.model_type = "GT+RL"
        self.training_mode = "RL"  # Set to RL mode for reinforcement learning
        self.training_mode = "RL"  # Set to RL mode for reinforcement learning
    ...
    def decode(self, instances: List[Dict], return_log_probs: bool = False,
               temperature: float = 1.0, greedy: bool = False, 
               max_steps: Optional[int] = None, **kwargs) -> Union[List[List[int]], Tuple[List[List[int]], torch.Tensor]]:
        """Decode method for RL training compatibility.
        ...
        Returns:
            Routes if return_log_probs is False, otherwise (routes, log_probs)
        """
        routes, log_probs, _ = self.forward(
            instances, 
            max_steps=max_steps,
